...
# print('hello.txt 파일에A 새로운 내용이 생성되었습니다.')
# file.close()
#
...
# file.close()
# 파이썬 버전업으로 인해 import 할 필요가 없어짐. open에서도 encoding 지원함

# # 파일 입력 input
# # 1. 텍스트 파일 읽기
# file = open('./output/hello.txt', 'rt')
# print(file) # <_io.TextIOWrapper name='./output/hello.txt' mode='rt' encoding='cp65001'>
#
...
# file = open('input/hello.txt', 'rt',encoding='utf-8')
#
