...
# file = open('../chapter4/output/hello.txt', 'at')
#
# file.write('Hello.\n')
...
# # file.close()
#
# file = open('../chapter4/output/한글파일.txt', 'w', encoding='utf-8')
# file.write("오늘 나는 학교에 갔습니다.")
# file.close()
...
# # 파일 입력 input
# # 1. 텍스트 파일 읽기
# file = open('../chapter4/output/hello.txt', 'rt')
#
...
# print()
# file = open('../chapter4/input/hello.txt', 'rt')
#
